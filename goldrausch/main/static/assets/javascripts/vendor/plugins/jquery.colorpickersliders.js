        ...
        return this.each(function() {
            ...
            function _buildHtml() {
                ...
                if (settings.order.opacity !== false) {
                    sliders[settings.order.opacity] = '<div class="cp-slider cp-opacity cp-transparency"><span class="background"></span><span class="label"><label>' + settings.labels.opacity + '</label></label></span><div class="cp-marker"></div></div>';
                }

                if (settings.order.hsl !== false) {
                    sliders[settings.order.hsl] = '<div class="cp-slider cp-hsllightness cp-transparency"><span class="background"></span><span class="label"><label>' + settings.labels.hsllightness + '</label></span><div class="cp-marker"></div></div><div class="cp-slider cp-hslsaturation cp-transparency"><span class="background"></span><span class="label"><label>' + settings.labels.hslsaturation + '</label></span><div class="cp-marker"></div></div><div class="cp-slider cp-hslhue cp-transparency"><span class="background"></span><span class="label"><label>' + settings.labels.hslhue + '</label></span><div class="cp-marker"></div></div>';
                }

                if (settings.order.rgb !== false) {
                    sliders[settings.order.rgb] = '<div class="cp-slider cp-rgbred cp-transparency"><span class="background"></span><span class="label"><label>' + settings.labels.rgbred + '</label></span><div class="cp-marker"></div></div><div class="cp-slider cp-rgbgreen cp-transparency"><span class="background"></span><span class="label"><label>' + settings.labels.rgbgreen + '</label></span><div class="cp-marker"></div></div><div class="cp-slider cp-rgbblue cp-transparency"><span class="background"></span><span class="label"><label>' + settings.labels.rgbblue + '</label></span><div class="cp-marker"></div></div>';
                }

                if (settings.order.cie !== false) {
                    sliders[settings.order.cie] = '<div class="cp-slider cp-cielightness cp-transparency"><span class="background"></span><span class="label"><label>' + settings.labels.cielightness + '</label></span><div class="cp-marker"></div></div><div class="cp-slider cp-ciechroma cp-transparency"><span class="background"></span><span class="label"><label>' + settings.labels.ciechroma + '</label></span><div class="cp-marker"></div></div><div class="cp-slider cp-ciehue cp-transparency"><span class="background"></span><span class="label"><label>' + settings.labels.ciehue + '</label></span><div class="cp-marker"></div></div>';
                }

                if (settings.order.preview !== false) {
                    sliders[settings.order.preview] = '<div class="cp-preview cp-transparency"><input type="text" readonly="readonly" data-role="none"></div>';
                }
            ...
            function _initElements() {
                elements = {
                    ...
                    sliders: {
                        hue: $(".cp-hslhue span.background", container),
                        hue_marker: $(".cp-hslhue .cp-marker", container),
                        saturation: $(".cp-hslsaturation span.background", container),
                        saturation_marker: $(".cp-hslsaturation .cp-marker", container),
                        lightness: $(".cp-hsllightness span.background", container),
                        lightness_marker: $(".cp-hsllightness .cp-marker", container),
                        opacity: $(".cp-opacity span.background", container),
                        opacity_marker: $(".cp-opacity .cp-marker", container),
                        red: $(".cp-rgbred span.background", container),
                        red_marker: $(".cp-rgbred .cp-marker", container),
                        green: $(".cp-rgbgreen span.background", container),
                        green_marker: $(".cp-rgbgreen .cp-marker", container),
                        blue: $(".cp-rgbblue span.background", container),
                        blue_marker: $(".cp-rgbblue .cp-marker", container),
                        cielightness: $(".cp-cielightness span.background", container),
                        cielightness_marker: $(".cp-cielightness .cp-marker", container),
                        ciechroma: $(".cp-ciechroma span.background", container),
                        ciechroma_marker: $(".cp-ciechroma .cp-marker", container),
                        ciehue: $(".cp-ciehue span.background", container),
            ...
            function _updateAllElements(disableinputupdate) {
                ...
                if ((100 - color.cielch.l) * color.cielch.a < settings.previewcontrasttreshold) {
                    elements.all_sliders.css('color', 'rgba(0,0,0, 0.5)');
                    if (settings.previewontriggerelement) {
                        triggerelement.css('background', color.tiny.toRgbString()).css('color', 'rgba(0,0,0, 0.5)');
                    }
                }
                else {
                    elements.all_sliders.css('color', 'rgba(255,255,255, 0.5)');
                    if (settings.previewontriggerelement) {
                        triggerelement.css('background', color.tiny.toRgbString()).css('color', 'rgba(255,255,255, 0.5)');
                    }
                }
