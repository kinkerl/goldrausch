...
TEMPLATE_DIRS = (
	'/home/pi/goldrausch/goldrausch/main/templates'
)

MEDIA_ROOT = '/home/pi/goldrausch/media'
MEDIA_URL = '/media/'

STATIC_ROOT = '/home/pi/goldrausch/goldrausch/static/'
STATIC_URL = '/static/'

#Path to search for the compiled(!) gettext Translations
LOCALE_PATHS += ('/home/pi/goldrausch/goldrausch/locale', )
